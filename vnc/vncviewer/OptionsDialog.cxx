...
public:
  ...
  virtual void initDialog() {
	...
	// Key code remap
	{
		HWND altKC = GetDlgItem(handle, IDC_ALT_KC);
		SendMessage(altKC, CB_ADDSTRING, 0, (LPARAM)_T("1'3457'908"));
		SendMessage(altKC, CB_ADDSTRING, 0, (LPARAM)_T("1:3457:908"));
		SendMessage(altKC, CB_SETCURSEL, dlg->options.altKeyCode, 0);
	}
  }
  virtual bool onOk() {
	...
	HWND altkcHwnd = GetDlgItem(handle, IDC_ALT_KC);
	dlg->options.altKeyCode = SendMessage(altkcHwnd, CB_GETCURSEL, 0, 0);
